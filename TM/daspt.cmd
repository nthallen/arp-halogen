...
&daspt_cmd <int>
	...
	: &dhzone SetPoint { $0 = $1.dhtr->addr[$1.zone]; }
	;
&flowspt_cmd <int>
	...
	;
&daspt16_cmd <int>
	: APD 1 HV Setpoint { $0 = 0xCF0; }
	: APD 2 HV Setpoint { $0 = 0xDF0; }
	;
...
&setpt5 <unsigned short>
	...
	;
&setpt16 <unsigned short>
	: %d (Enter Setpoint Value 0-16383) {
		$0 = $1;
		if ( $0 >= 16384 ) {
		  nl_error( 2, "Setpoint out of range" );
		  CANCEL_LINE;
		}
	  }
	;
