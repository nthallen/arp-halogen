...
f = ne_dialg(f, 'add', 0, 1, 'ghalbmm', 'BMM' );
f = ne_dialg(f, 'add', 1, 0, 'phalbmmi', 'I' );
f = ne_dialg(f, 'add', 1, 0, 'phalbmmv', 'V' );
f = ne_dialg(f, 'add', 1, 0, 'phalbmmn', 'N' );
f = ne_dialg(f, 'add', 1, 0, 'phalbmmt', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'phalbmms', 'Status' );
